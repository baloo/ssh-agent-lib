...
pub enum PrivateKeyData {
    ...
    // Note: OpenSSH is a little inconsistent, Ed25519 is the only ona
    // algorithm that will always encode the full keypair.
    /// Ed25519 keypair.
...
impl fmt::Debug for PrivateKeyData {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            Self::Ed25519(kp) => write!(f, "PrivateKeyData::Ed25519({kp:?})"),
